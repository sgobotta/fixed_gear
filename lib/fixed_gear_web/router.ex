defmodule FixedGearWeb.Router do
  use FixedGearWeb, :router

  import FixedGearWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {FixedGearWeb.Layouts, :root}
  ...
  if Application.compile_env(:fixed_gear, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FixedGearWeb.Telemetry
  ...
  scope "/", FixedGearWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FixedGearWeb.UserAuth, :require_authenticated}] do
