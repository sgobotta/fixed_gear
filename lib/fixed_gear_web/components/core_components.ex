defmodule FixedGearWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FixedGearWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FixedGearWeb.Gettext, "errors", msg, opts)
    end
  end
