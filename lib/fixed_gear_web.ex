defmodule FixedGearWeb do
  ...
  def static_paths,
    do:
      ~w(assets fonts images favicon.ico favicon.svg apple-touch-icon.png robots.txt)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: FixedGearWeb.Router,
        statics: FixedGearWeb.static_paths()
    end
  end
