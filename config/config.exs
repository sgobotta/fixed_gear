...
config :fixed_gear, FixedGearWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FixedGearWeb.ErrorHTML, json: FixedGearWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: FixedGear.PubSub,
  live_view: [signing_salt: "kvLm02PY"]
...
config :fixed_gear, FixedGear.Mailer, adapter: Swoosh.Adapters.Local
